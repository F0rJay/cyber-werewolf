...
请根据当前情况，进行发言。发言要求：
1. **必须针对上文的发言进行分析**：不要只说场面话，要针对前面玩家的发言内容进行具体分析
2. **给出具体的推理和判断**：基于前面玩家的发言，分析谁可能是狼人，谁可能是好人，给出你的判断和理由
3. **指出矛盾和疑点**：如果发现前面玩家的发言有矛盾或疑点，要明确指出
4. **表达你的观点**：基于分析，明确表达你怀疑谁、相信谁，以及原因
5. **符合你的角色身份**：发言要符合你的角色身份（好人要帮助找出狼人，狼人要隐藏身份）
